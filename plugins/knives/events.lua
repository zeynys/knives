AddEventHandler("OnPluginStart", function(event)
    ...
    db:Query(
        "CREATE TABLE `knives` (`steamid` VARCHAR(64) NOT NULL , `t` VARCHAR(64) NOT NULL , `ct` VARCHAR(64) NOT NULL , `knives_data` JSON NOT NULL DEFAULT '{}' , UNIQUE (`steamid`)) ENGINE = InnoDB;"
    )
